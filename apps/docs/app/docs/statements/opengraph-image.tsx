...
export const alt =
  '@cynco/statements — trial balance, income statement, and balance sheet ' +
  'derived from entries. Computed proofs, flagged never plugged.';

export default function OpengraphImage() {
  return renderPackageOgImage('/docs/statements');
}
