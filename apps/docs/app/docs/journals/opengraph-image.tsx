...
export const alt =
  '@cynco/journals — journal entries, virtualized registers, ' +
  'reconciliation. Vanilla core, React adapters, declarative shadow DOM SSR.';

export default function OpengraphImage() {
  return renderPackageOgImage('/docs/journals');
}
