...
// track reads primary; unchecked reads the input tint.
  ...
  return (
    ...
    >
      <SwitchPrimitives.Thumb
        ...
        className="bg-background pointer-events-none block h-3 w-3 rounded-full ring-0 transition-transform data-[state=checked]:translate-x-2 data-[state=unchecked]:translate-x-0"
      />
    </SwitchPrimitives.Root>
  );
}
