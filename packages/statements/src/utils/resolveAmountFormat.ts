 ...
 *
 * HOST-SIDE ONLY — never call this from a renderer module (and no renderer
 * imports this file). ICU data differs across Node
 ...
 * therefore break the server/client byte-parity contract the renderers
 * guarantee. The supported
