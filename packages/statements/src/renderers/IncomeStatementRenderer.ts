...
import type { IncomeStatementData, IncomeStatementSection } from '../types';
 ...
 */
export function renderIncomeStatementHTML(data: IncomeStatementData): string {
...
function renderSectionHTML(
  ...
  for (const line of section.income) {
    html += renderLineRowHTML(line, section.currency, 'period');
  }
