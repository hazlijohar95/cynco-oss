...
// Shared requestAnimationFrame queue: every component and virtualizer in the
// page funnels its render work through one frame callback so N instances
// never schedule N competing frames.
